 ...
 */
        ...
        uint32 GraveyardsAssaulted;  ///< Number of assaulted graveyards
        uint32 GraveyardsDefended;   ///< Number of defended graveyards
        uint32 TowersAssaulted;      ///< Number of assaulted towers
        uint32 TowersDefended;       ///< Number of defended towers
