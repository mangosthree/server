 ...
 *
 * The world thread hands each map's Update() to this pool via
 * schedule_update(), then blocks in wait() until the whole tick has been
 * processed.
 */
...
class MapUpdater
{
    public:
         ...
         *
         * This is the tick barrier: the world thread must not advance until
         * every map queued this tick has been updated.
         *
         * @return Always 0.
         */
        int wait();
