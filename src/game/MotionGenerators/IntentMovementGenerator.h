 ...
 * unit states, AI informs, walk flags, its own timers. It no longer touches MECHANISM:
 * PathFinder, MoveSplineInit, movespline, and every hand-rolled copy of "has my goal
 * drifted far enough to re-path".
 */
