...
/* hardcoded in client, starting from this level, guild daily experience gain is unlimited */
...
class EmblemInfo
{
    public:
        ...
        void ReadPacket(WorldPacket& recv_data)
        {
            recv_data >> m_style >> m_color >> m_borderStyle >> m_borderColor >> m_backgroundColor;
        }
...
class Guild
{
    private:
        class Member
        {
            ...
            public:
                Member(uint32 guildId, const uint64& guid, uint8 rankId) :
                    m_guildId(guildId), m_guid(guid), m_logoutTime(::time(nullptr)), m_rankId(rankId) { }
            ...
            private:
                ...
                /* Fields from guild member table */
                uint8  m_rankId;
        ...
        /* Class incapsulation guild rank data */
        class RankInfo
        {
            public:
    ...
    public:
        ...
        uint64 GetGUID() const { return (m_id, 0, HIGHGUID_GUILD); }
