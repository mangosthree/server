 ...
 *        type-specific field validation (the file-local SQLGameObjectLoader
 *        struct + CheckGO* helpers travel with LoadGameobjectInfo, their sole
 *        user). Same `ObjectMgr` class; no behaviour change. CMake
