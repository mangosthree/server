...
enum Opcodes
{
    ...
    CMSG_MOVE_CHARM_PORT_CHEAT                            = 0x0000,
    ...
    CMSG_INSTANCE_LOCK_RESPONSE                           = 0x0000,
    CMSG_DEBUG_PASSIVE_AURA                               = 0x0000,
    ...
    CMSG_PERFORM_ACTION_SET                               = 0x0000,
    ...
    SMSG_REMOVED_FROM_PVP_QUEUE                           = 0x0000,
    ...
    SMSG_QUESTUPDATE_ADD_ITEM_OBSOLETE                    = 0x0000,
    ...
    SMSG_RWHOIS                                           = 0x6917, // 4.3.4 15595
    ...
    SMSG_INSTANCE_ENCOUNTER                               = 0x0000,
    ...
    MSG_MOVE_UPDATE_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY   = 0x0000,
    ...
    CMSG_LFG_SEARCH_JOIN                                  = 0x0000,
    CMSG_LFG_SEARCH_LEAVE                                 = 0x0000,
    SMSG_LFG_SEARCH_RESULTS                               = 0x0000,
    SMSG_LFG_PROPOSAL_UPDATE                              = 0x0000,
    CMSG_LFG_PROPOSAL_RESPONSE                            = 0x0000,
    ...
    CMSG_CALENDAR_GET_EVENT                               = 0x6416, // 4.3.4 15595
    CMSG_CALENDAR_GUILD_FILTER                            = 0x4A16, // 4.3.4 15595
    CMSG_CALENDAR_ARENA_TEAM                              = 0x0204, // 4.3.4 15595
    CMSG_CALENDAR_ADD_EVENT                               = 0x0726, // 4.3.4 15595
    CMSG_CALENDAR_UPDATE_EVENT                            = 0x2114, // 4.3.4 15595
    CMSG_CALENDAR_REMOVE_EVENT                            = 0x6636, // 4.3.4 15595
    CMSG_CALENDAR_COPY_EVENT                              = 0x0207, // 4.3.4 15595
    CMSG_CALENDAR_EVENT_INVITE                            = 0x2435, // 4.3.4 15595
    CMSG_CALENDAR_EVENT_RSVP                              = 0x0227, // 4.3.4 15595
    CMSG_CALENDAR_EVENT_REMOVE_INVITE                     = 0x4337, // 4.3.4 15595
    CMSG_CALENDAR_EVENT_STATUS                            = 0x2D24, // 4.3.4 15595
    ...
    SMSG_CALENDAR_COMMAND_RESULT                          = 0x6F36, // 4.3.4 15595
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                      = 0x2305, // 4.3.4 15595
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                    = 0x2E25, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_INVITE_ALERT                      = 0x2A05, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT              = 0x2617, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT               = 0x6625, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                     = 0x6D35, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                     = 0x0907, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_MODERATOR_STATUS_ALERT            = 0x6B06, // 4.3.4 15595
    CMSG_CALENDAR_COMPLAIN                                = 0x4C36, // 4.3.4 15595
    ...
    CMSG_CALENDAR_EVENT_INVITE_NOTES                      = 0x0000,
    SMSG_CALENDAR_EVENT_INVITE_NOTES                      = 0x0E17, // 4.3.4 15595
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT                = 0x2535, // 4.3.4 15595
    ...
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                    = 0x4636, // 4.3.4 15595
    ...
    CMSG_SERVER_INFO_QUERY                                = 0x0000,
    SMSG_SERVER_INFO_RESPONSE                             = 0x0000,
    CMSG_CHECK_LOGIN_CRITERIA                             = 0x0000,
    ...
    CMSG_SET_ARENA_TEAM_RATING_BY_INDEX                   = 0x0000,
    CMSG_SET_ARENA_TEAM_WEEKLY_GAMES                      = 0x0000,
    CMSG_SET_ARENA_TEAM_SEASON_GAMES                      = 0x0000,
    CMSG_SET_ARENA_MEMBER_WEEKLY_GAMES                    = 0x0000,
    CMSG_SET_ARENA_MEMBER_SEASON_GAMES                    = 0x0000,
    ...
    CMSG_ON_MISSILE_TRAJECTORY_COLLISION                  = 0x0000,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION              = 0x0000,
    ...
    CMSG_SET_ACTIVE_TALENT_GROUP_OBSOLETE                 = 0x0000,
    CMSG_GM_GRANT_ACHIEVEMENT                             = 0x0000,
    CMSG_GM_REMOVE_ACHIEVEMENT                            = 0x0000,
    CMSG_GM_SET_CRITERIA_FOR_PLAYER                       = 0x0000,
    SMSG_DESTROY_ARENA_UNIT                               = 0x2637, // 4.3.4 15595
    SMSG_ARENA_TEAM_CHANGE_FAILED                         = 0x0000,
    CMSG_PROFILEDATA_REQUEST                              = 0x0000,
    SMSG_PROFILEDATA_RESPONSE                             = 0x0000,
    CMSG_START_BATTLEFIELD_CHEAT                          = 0x0000,
    CMSG_END_BATTLEFIELD_CHEAT                            = 0x0000,
    SMSG_COMPOUND_MOVE                                    = 0x0000,
    ...
    CMSG_FORCE_ANIM                                       = 0x0000,
    SMSG_FORCE_ANIM                                       = 0x0000,
    CMSG_CHAR_FACTION_CHANGE                              = 0x2735, // 4.3.4 15595
    SMSG_CHAR_FACTION_CHANGE                              = 0x4C06, // 4.3.4 15595
    CMSG_PVP_QUEUE_STATS_REQUEST                          = 0x0000,
    SMSG_PVP_QUEUE_STATS                                  = 0x0000,
    CMSG_SET_PAID_SERVICE_CHEAT                           = 0x0000,
    SMSG_BATTLEFIELD_MANAGER_ENTRY_INVITE                 = 0x0000,
    CMSG_BATTLEFIELD_MANAGER_ENTRY_INVITE_RESPONSE        = 0x0000,
    SMSG_BATTLEFIELD_MANAGER_ENTERING                     = 0x0000,
    SMSG_BATTLEFIELD_MANAGER_QUEUE_INVITE                 = 0x0000,
    CMSG_BATTLEFIELD_MANAGER_QUEUE_INVITE_RESPONSE        = 0x0000,
    CMSG_BATTLEFIELD_MANAGER_QUEUE_REQUEST                = 0x710C, // 4.3.4 15595 
    SMSG_BATTLEFIELD_MANAGER_QUEUE_REQUEST_RESPONSE       = 0x0000,
    SMSG_BATTLEFIELD_MANAGER_EJECT_PENDING                = 0x0000,
    SMSG_BATTLEFIELD_MANAGER_EJECTED                      = 0x0000,
    CMSG_BATTLEFIELD_MANAGER_EXIT_REQUEST                 = 0x0000,
    SMSG_BATTLEFIELD_MANAGER_STATE_CHANGED                = 0x0000,
    CMSG_BATTLEFIELD_MANAGER_ADVANCE_STATE                = 0x0000,
    CMSG_BATTLEFIELD_MANAGER_SET_NEXT_TRANSITION_TIME     = 0x0000,
    MSG_SET_RAID_DIFFICULTY                               = 0x0614, // 4.3.4 15595
    CMSG_XPGAIN                                           = 0x0000,
    SMSG_XPGAIN                                           = 0x0000,
    SMSG_GMTICKET_RESPONSE_ERROR                          = 0x0000,
    ...
    SMSG_GMTICKET_CREATE_RESPONSE_TICKET                  = 0x0000,
    CMSG_GM_CREATE_TICKET_RESPONSE                        = 0x0000,
    CMSG_SERVERINFO                                       = 0x0000,
    SMSG_SERVERINFO                                       = 0x0000,
    CMSG_UI_TIME_REQUEST                                  = 0x4605, // 4.3.4 15595
    SMSG_UI_TIME                                          = 0x4A14, // 4.3.4 15595
    CMSG_CHAR_RACE_CHANGE                                 = 0x0D24, // 4.3.4 15595
    MSG_VIEW_PHASE_SHIFT                                  = 0x0000,
    SMSG_TALENTS_INVOLUNTARILY_RESET                      = 0x0000,
    CMSG_DEBUG_SERVER_GEO                                 = 0x0000,
    SMSG_DEBUG_SERVER_GEO                                 = 0x0000,
    SMSG_LOOT_UPDATE                                      = 0x0000,
    UMSG_UPDATE_GROUP_INFO                                = 0x0000,
    ...
    CMSG_GMLAGREPORT_SUBMIT                               = 0x0000,
    CMSG_AFK_MONITOR_INFO_REQUEST                         = 0x0000,
    SMSG_AFK_MONITOR_INFO_RESPONSE                        = 0x0000,
    CMSG_AFK_MONITOR_INFO_CLEAR                           = 0x0000,
    ...
    CMSG_SET_CHARACTER_MODEL                              = 0x0000,
    SMSG_CONNECT_TO                                       = 0x0942, // 4.3.4 15595
    CMSG_CONNECT_TO_FAILED                                = 0x0000,
    SMSG_SUSPEND_COMMS                                    = 0x0000,
    CMSG_SUSPEND_COMMS_ACK                                = 0x0000,
    SMSG_RESUME_COMMS                                     = 0x0000,
    CMSG_AUTH_CONTINUED_SESSION                           = 0x0000,
    CMSG_DROP_NEW_CONNECTION                              = 0x0000,
    SMSG_SEND_ALL_COMBAT_LOG                              = 0x0000,
    SMSG_OPEN_LFG_DUNGEON_FINDER                          = 0x0412, // 4.3.4 15595
    SMSG_MOVE_SET_COLLISION_HGT                           = 0x11B0, // 4.3.4 15595
    CMSG_MOVE_SET_COLLISION_HGT_ACK                       = 0x0000,
    MSG_MOVE_SET_COLLISION_HGT                            = 0x0000,
    CMSG_CLEAR_RANDOM_BG_WIN_TIME                         = 0x0000,
    CMSG_CLEAR_HOLIDAY_BG_WIN_TIME                        = 0x0000,
    ...
    SMSG_COMPRESSED_UNKNOWN_1310                          = 0x0000,
    SMSG_UNKNOWN_1311                                     = 0x0000,
    SMSG_UNKNOWN_1312                                     = 0x0000,
    UMSG_UNKNOWN_1313                                     = 0x0000,
    SMSG_UNKNOWN_1314                                     = 0x0000,
    SMSG_UNKNOWN_1315                                     = 0x0000,
    SMSG_UNKNOWN_1316                                     = 0x0000,
    SMSG_UNKNOWN_1317                                     = 0x0000,
    UMSG_UNKNOWN_1318                                     = 0x0000,
    UMSG_UNKNOWN_1319                                     = 0x0000,
    CMSG_UNKNOWN_1320                                     = 0x0000,
    UMSG_UNKNOWN_1321                                     = 0x0000,
    UMSG_UNKNOWN_1322                                     = 0x0000,
    UMSG_UNKNOWN_1323                                     = 0x0000,
    UMSG_UNKNOWN_1324                                     = 0x0000,
    UMSG_UNKNOWN_1325                                     = 0x0000,
    UMSG_UNKNOWN_1326                                     = 0x0000,
    UMSG_UNKNOWN_1327                                     = 0x0000,
    UMSG_UNKNOWN_1328                                     = 0x0000,
    SMSG_UNKNOWN_1329                                     = 0x0000,
    UMSG_UNKNOWN_1330                                     = 0x0000,
    UMSG_UNKNOWN_1331                                     = 0x0000,
    UMSG_UNKNOWN_1332                                     = 0x0000,
    UMSG_UNKNOWN_1333                                     = 0x0000,
    UMSG_UNKNOWN_1334                                     = 0x0000,
