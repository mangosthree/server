...
constexpr uint8 Cata15595X64MpqCode = 0x90;
...
// The code is reachable only for an exact current-Grunt profile whose probed
// adapter supplies the signed module's required file-reader ABI.
