...
void CasterShamanStrategy::InitTriggers(std::list<TriggerNode*> &triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "shock",
        NextAction::array(0, new NextAction("flame shock", 22.0f), NULL)));

    triggers.push_back(new TriggerNode(
        "fulmination",
        NextAction::array(0, new NextAction("earth shock", 18.0f), NULL)));
    ...
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(0, new NextAction("fire elemental totem", 28.0f), NULL)));
