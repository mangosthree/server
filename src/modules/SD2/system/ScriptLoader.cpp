...
// eastern kingdoms
void AddSC_ascendant_council();                      // bastion_of_twilight
void AddSC_boss_chogall();
void AddSC_boss_halfus_wyrmbreaker();
void AddSC_boss_sinestra();
void AddSC_boss_valiona_and_theralion();
void AddSC_instance_bastion_of_twilight();
void AddSC_boss_beauty();                            // BM, blackrock_caverns
...
void AddSC_boss_adramedes();                         // BM, blackwing_descent
...
void AddSC_boss_drahga_shadowburner();               // grim_batol
...
void AddSC_boss_commander_ulthok();                  // throne_of_the_tides
...
void AddSC_boss_deathwing();                         // COT, dragon_soul
...
void AddSC_end_of_time();                            // COT, end_of_time
void AddSC_instance_end_of_time();
void AddSC_boss_archbishop_benedictus();             // COT, hour_of_twilight
...
void AddSC_boss_alakir();                            // throne_of_the_four_winds
void AddSC_conclave_of_the_wind();
void AddSC_instance_throne_of_the_four_winds();
void AddSC_boss_altairus();                          // vortex_pinnacle
