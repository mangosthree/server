...
struct boss_malchezaar : public CreatureScript
{
...
struct npc_infernal_target : public CreatureScript
{
    npc_infernal_target() : CreatureScript("npc_infernal_target") {}
...
void AddSC_boss_prince_malchezaar()
{
    ...
    s = new boss_malchezaar();
    s->RegisterSelf();
    s = new npc_infernal_target();
    s->RegisterSelf();
