...
struct boss_terestian_illhoof : public CreatureScript
{
...
struct npc_fiendish_portal : public CreatureScript
{
...
struct mob_demon_chain : public CreatureScript
{
...
void AddSC_boss_terestian_illhoof()
{
    ...
    s = new boss_terestian_illhoof();
    s->RegisterSelf();
    s = new npc_fiendish_portal();
    s->RegisterSelf();
    s = new mob_demon_chain();
    s->RegisterSelf();
