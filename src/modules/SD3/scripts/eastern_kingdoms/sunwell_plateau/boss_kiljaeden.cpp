...
struct npc_kiljaeden_controller : public CreatureScript
{
...
struct boss_kiljaeden : public CreatureScript
{
...
struct aura_dummy_darkness_of_souls : public AuraScript
{
    aura_dummy_darkness_of_souls() : AuraScript("aura_dummy_darkness_of_souls") {}
...
struct npc_shield_orb : public CreatureScript
{
...
struct npc_power_blue_flight : public CreatureScript
{
...
void AddSC_boss_kiljaeden()
{
    ...
    s = new npc_kiljaeden_controller();
    s->RegisterSelf();
    s = new aura_dummy_darkness_of_souls();
    s->RegisterSelf();
    s = new boss_kiljaeden();
    s->RegisterSelf();
    s = new npc_shield_orb();
    s->RegisterSelf();
    s = new npc_power_blue_flight();
    s->RegisterSelf();
