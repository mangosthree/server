...
struct boss_akilzon : public CreatureScript
{
...
//** mob_soaring_eagle
struct mob_soaring_eagle : public CreatureScript
{
    mob_soaring_eagle() : CreatureScript("mob_soaring_eagle") {}
