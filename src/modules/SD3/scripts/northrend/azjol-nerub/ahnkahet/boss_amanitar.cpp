...
struct boss_amanitar : public CreatureScript
{
...
struct npc_amanitar_mushroom : public CreatureScript
{
    npc_amanitar_mushroom() : CreatureScript("npc_amanitar_mushroom") {}
