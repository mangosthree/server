...
struct boss_anubarak : public CreatureScript
{
    boss_anubarak() : CreatureScript("boss_anubarak") {}
...
struct npc_impale_target : public CreatureScript
{
