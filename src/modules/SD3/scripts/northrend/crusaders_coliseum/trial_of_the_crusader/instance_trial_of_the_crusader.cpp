...
struct is_trial_of_the_crusader : public InstanceScript
{
    is_trial_of_the_crusader() : InstanceScript("instance_trial_of_the_crusader") {}

    class instance_trial_of_the_crusader : public ScriptedInstance, private DialogueHelper
    {
    public:
        instance_trial_of_the_crusader(Map* pMap) : ScriptedInstance(pMap), DialogueHelper(aTocDialogues),
            m_uiTeam(TEAM_NONE)
        {
            Initialize();
        }
    ...
    private:
        ...
        void JustDidDialogueStep(int32 iEntry) override
        {
            ...
            case SAY_VARIAN_BEAST_1:
                ...
                {
                    if (Creature* pBeasts = pPlayer->SummonCreature(NPC_BEAST_COMBAT_STALKER, aSpawnPositions[0][0], aSpawnPositions[0][1], aSpawnPositions[0][2], aSpawnPositions[0][3], TEMPSPAWN_DEAD_DESPAWN, 0))
                    {
                        pBeasts->SummonCreature(NPC_GORMOK, aSpawnPositions[1][0], aSpawnPositions[1][1], aSpawnPositions[1][2], aSpawnPositions[1][3], TEMPSPAWN_DEAD_DESPAWN, 0);
                    }
                }
                break;
            case NPC_FIZZLEBANG:
...
void AddSC_instance_trial_of_the_crusader()
{
    ...
    s = new is_trial_of_the_crusader();
    s->RegisterSelf();
