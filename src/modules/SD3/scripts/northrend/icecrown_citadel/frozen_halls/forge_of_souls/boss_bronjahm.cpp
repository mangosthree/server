...
SD%Complete: 90%
SDComment: Small unknown behaviour for his Shadow Bolt use in phase 1; Soulstorm needs additional handling in core
...
struct boss_bronjahm : public CreatureScript
{
...
struct npc_corrupted_soul_fragment : public CreatureScript
{
...
void AddSC_boss_bronjahm()
{
    ...
    s = new boss_bronjahm();
    s->RegisterSelf();
    s = new npc_corrupted_soul_fragment();
    s->RegisterSelf();
