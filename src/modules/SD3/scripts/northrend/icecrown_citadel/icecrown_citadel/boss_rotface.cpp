...
struct boss_rotface : public CreatureScript
{
...
struct mob_little_ooze : public CreatureScript
{
    mob_little_ooze() : CreatureScript("mob_little_ooze") {}
...
struct mob_big_ooze : public CreatureScript
{
    mob_big_ooze() : CreatureScript("mob_big_ooze") {}
