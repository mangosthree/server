...
struct boss_malygos : public CreatureScript
{
...
struct npc_power_spark : public CreatureScript
{
...
struct npc_wyrmrest_skytalon : public CreatureScript
{
...
struct event_go_focusing_iris : public MapEventScript
{
    event_go_focusing_iris() : MapEventScript("event_go_focusing_iris") {}
...
void AddSC_boss_malygos()
{
    ...
    s = new boss_malygos();
    s->RegisterSelf();
    s = new npc_power_spark();
    s->RegisterSelf();
    s = new npc_wyrmrest_skytalon();
    s->RegisterSelf();

    s = new event_go_focusing_iris();
    s->RegisterSelf();
