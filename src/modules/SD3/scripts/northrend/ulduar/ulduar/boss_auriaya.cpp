...
struct boss_auriaya : public CreatureScript
{
...
struct boss_feral_defender : public CreatureScript
{
    boss_feral_defender() : CreatureScript("boss_feral_defender") {}
