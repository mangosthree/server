...
struct boss_freya : public CreatureScript
{
    ...
    struct boss_freyaAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            Mangos::random_shuffle(spawnSpellsVector.begin(), spawnSpellsVector.end());
        }
...
struct npc_water_spirit : public CreatureScript
{
    npc_water_spirit() : CreatureScript("npc_water_spirit") {}
...
struct npc_snaplasher : public CreatureScript
{
...
struct npc_eonars_gift : public CreatureScript
{
...
struct npc_nature_bomb : public CreatureScript
{
...
struct npc_iron_roots : public CreatureScript
{
...
struct npc_healthy_spore : public CreatureScript
{
...
void AddSC_boss_freya()
{
    ...
    s = new boss_freya();
    s->RegisterSelf();
    s = new npc_water_spirit();
    s->RegisterSelf();
    s = new npc_snaplasher();
    s->RegisterSelf();
    s = new npc_storm_lasher();
    s->RegisterSelf();
    s = new npc_eonars_gift();
    s->RegisterSelf();
    s = new npc_nature_bomb();
    s->RegisterSelf();
    s = new npc_iron_roots();
    s->RegisterSelf();
