...
struct boss_skadi : public CreatureScript
{
...
struct npc_grauf : public CreatureScript
{
...
struct aura_skadi_cloud : public AuraScript
{
    aura_skadi_cloud() : AuraScript("aura_skadi_cloud") {}
...
struct at_skadi : public AreaTriggerScript
{
    at_skadi() : AreaTriggerScript("at_skadi") {}
