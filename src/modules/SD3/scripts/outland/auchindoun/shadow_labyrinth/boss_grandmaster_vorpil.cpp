...
struct boss_grandmaster_vorpil : public CreatureScript
{
...
struct npc_void_traveler : public CreatureScript
{
...
void AddSC_boss_grandmaster_vorpil()
{
    ...
    s = new boss_grandmaster_vorpil();
    s->RegisterSelf();
    s = new npc_void_traveler();
    s->RegisterSelf();
