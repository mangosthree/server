...
struct boss_morogrim_tidewalker : public CreatureScript
{
...
struct mob_water_globule : public CreatureScript
{
...
void AddSC_boss_morogrim_tidewalker()
{
    ...
    s = new boss_morogrim_tidewalker();
    s->RegisterSelf();
    s = new mob_water_globule();
    s->RegisterSelf();
