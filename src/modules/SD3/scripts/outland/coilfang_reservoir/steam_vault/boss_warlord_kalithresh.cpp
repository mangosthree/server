...
struct boss_warlord_kalithresh : public CreatureScript
{
...
struct aura_dummy_warlord_rage : public AuraScript
{
    aura_dummy_warlord_rage() : AuraScript("aura_dummy_warlord_rage") {}
...
struct mob_naga_distiller : public CreatureScript
{
...
void AddSC_boss_warlord_kalithresh()
{
    ...
    s = new boss_warlord_kalithresh();
    s->RegisterSelf();
    s = new aura_dummy_warlord_rage();
    s->RegisterSelf();
    s = new mob_naga_distiller();
    s->RegisterSelf();
