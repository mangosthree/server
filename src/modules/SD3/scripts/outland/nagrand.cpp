...
struct mob_lump : public CreatureScript
{
...
struct npc_nagrand_captive : public CreatureScript
{
        ...
        void ReceiveAIEvent(AIEventType eventType, Creature* /*pSender*/, Unit* pInvoker, uint32 uiMiscValue) override
        {
            if (eventType == AI_EVENT_START_ESCORT && pInvoker->GetTypeId() == TYPEID_PLAYER)
            {
                if (m_creature->GetEntry() == NPC_MAGHAR_CAPTIVE)
                {
                    ...
                    m_creature->SummonCreature(NPC_MURK_RAIDER, m_afAmbushA[0] + 2.5f, m_afAmbushA[1] - 2.5f, m_afAmbushA[2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    m_creature->SummonCreature(NPC_MURK_PUTRIFIER, m_afAmbushA[0] - 2.5f, m_afAmbushA[1] + 2.5f, m_afAmbushA[2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    m_creature->SummonCreature(NPC_MURK_BRUTE, m_afAmbushA[0], m_afAmbushA[1], m_afAmbushA[2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                }
                else if (m_creature->GetEntry() == NPC_KURENAI_CAPTIVE)
                {
                    ...
                    m_creature->SummonCreature(NPC_MURK_RAIDER, -1509.606f, 8484.284f, -3.841f, 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    m_creature->SummonCreature(NPC_MURK_PUTRIFIER, -1532.475f, 8454.706f, -4.102f, 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    m_creature->SummonCreature(NPC_MURK_BRUTE, -1525.484f, 8475.383f, -2.482f, 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                }
...
struct npc_creditmarker_visit_with_ancestors : public CreatureScript
{
...
struct npc_rethhedron : public CreatureScript
{
...
void AddSC_nagrand()
{
    ...
    s = new mob_lump();
    s->RegisterSelf();
    s = new npc_nagrand_captive();
    s->RegisterSelf();
    s = new npc_creditmarker_visit_with_ancestors();
    s->RegisterSelf();
    s = new npc_rethhedron();
    s->RegisterSelf();
