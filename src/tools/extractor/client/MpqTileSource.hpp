...
namespace world::terrain
{
    ...
    public:
        ...
        /// The object half of a split tile -- <map>_<x>_<y>_obj0.adt. Empty
        /// string for a map with no directory; absent from a pre-4.x client.
        std::string AdtObjPath(uint32_t mapId, int tx, int ty) const;
